...
AWS Key Management Service (AWS KMS) is an encryption and key management web service. This guide describes the AWS KMS operations that you can call programmatically. For general information about AWS KMS, see the `AWS Key Management Service Developer Guide`_ .
...
.. note::
  ...
  AWS provides SDKs that consist of libraries and sample code for various programming languages and platforms (Java, Ruby, .Net, iOS, Android, etc.). The SDKs provide a convenient way to create programmatic access to AWS KMS and other AWS services. For example, the SDKs take care of tasks such as signing requests (see below), managing errors, and retrying requests automatically. For more information about the AWS SDKs, including how to download and install them, see `Tools for Amazon Web Services`_ .
...
All AWS KMS operations require `Signature Version 4`_ .
...
.. _AWS Security Token Service: http://docs.aws.amazon.com/STS/latest/UsingSTS/
.. _AWS CloudTrail User Guide: http://docs.aws.amazon.com/awscloudtrail/latest/userguide/
.. _AWS Key Management Service Developer Guide: http://docs.aws.amazon.com/kms/latest/developerguide/
