...
This is the API Reference for Amazon Simple Email Service (Amazon SES). This documentation is intended to be used in conjunction with the `Amazon SES Developer Guide <http://docs.aws.amazon.com/ses/latest/DeveloperGuide/Welcome.html>`_ . 
...
.. note::
  ...
  For a list of Amazon SES endpoints to use in service requests, see `Regions and Amazon SES <http://docs.aws.amazon.com/ses/latest/DeveloperGuide/regions.html>`_ in the Amazon SES Developer Guide. 
