...
A role can also have inline policies embedded with it. To delete an inline policy, use the  delete-role-policy API. For information about policies, see `Managed Policies and Inline Policies <http://docs.aws.amazon.com/IAM/latest/UserGuide/policies-managed-vs-inline.html>`_ in the *IAM User Guide* .
