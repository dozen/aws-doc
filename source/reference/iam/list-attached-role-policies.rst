...
A role can also have inline policies embedded with it. To list the inline policies for a role, use the  list-role-policies API. For information about policies, refer to `Managed Policies and Inline Policies`_ in the *IAM User Guide* . 
