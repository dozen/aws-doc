...
.. _cli:aws kinesis wait stream-exists:
...
``stream-exists`` is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of results. You can disable pagination by providing the ``--no-paginate`` argument.
